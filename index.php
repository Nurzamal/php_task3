...
<head>
  ...
  <style>
    ...
    /* Задайте высоту сетки, поэтому .sidenav может быть на 100% (при необходимости отрегулируйте) */
    .row.content {height: 450px}
    
    /* Установите серый цвет фона и высоту 100% */
    .middle {
      padding-top: 20px;
    ...
    /* Установите черный цвет фона, белый текст и некоторые дополнения */
    footer {
    ...
    /* На маленьких экранах установите высоту на «авто» для сиденава и сетки */
